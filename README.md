...
A Claude Code plugin for generating LaTeX Beamer presentations using the **keynote theme (Version 1)**. Supports a two-phase workflow: discuss and save a structured outline, then convert the outline to a compilable XeLaTeX `.tex` file.
